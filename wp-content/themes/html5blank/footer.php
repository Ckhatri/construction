<footer>
	<div class = "container">
		<div class = "row text-center">
			<div class = "col-xs-2 col-s-2 col-md-4 col-lg-4"></div>
			<div class = "col-xs-8 col-s-8 col-md-4 col-lg-4">
		...
		<div class = "row text-center">
			<div class = "col-xs-0 col-s-0 col-md-2 col-lg-2"></div>
			<div class = "col-xs-6 col-s-6 col-md-4 col-lg-4">
				<h3>Get in Touch</h3>
				<p><i class="fa fa-phone"></i> ###-###-####</p>
				<p><i class="fa fa-envelope-o"></i> person@email.site</p>
				<p><i class="fa fa-map-marker"></i> 1000 Not A Real Place, Texas, ######, USA</p>
